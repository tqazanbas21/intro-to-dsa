...
This is an array based implementation of Stack, i.e. static one. This data struture follows LIFO principle, i.e. last-in-first-out [1]. 
...
![Stack main operations diagram]("%22stack.jpg "Stack main operations") [1]
